        ...
        override fun onOpen(db: SupportSQLiteDatabase) {
            ...
            INSTANCE?.let { database ->
                scope.launch {
                    ...
                    // User Interface
                    dev = Dev("What is AppBar", "User Interface", "AppBar")
                    devDao.insert(dev)
                    dev = Dev("Setup AppBar", "User Interface", "AppBar")
                    devDao.insert(dev)
                    ...
                    devDao.insert(dev)
                    dev = Dev("TooTip", "User Interface", "Look and Feel")
                    devDao.insert(dev)
                    ...
                    devDao.insert(dev)
                    dev = Dev("Click Listner", "User Interface", "RecyclerView")
                    devDao.insert(dev)
