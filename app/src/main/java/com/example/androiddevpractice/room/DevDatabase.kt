        ...
        override fun onOpen(db: SupportSQLiteDatabase) {
            ...
            INSTANCE?.let { database ->
                scope.launch {
                    ...
                    devDao.insert(dev)
                    dev = Dev("Dialog", "UserInterface", mContext.getString(R.string.UI_Dialog_CustomLayout))
                    devDao.insert(dev)
                    ...
                    devDao.insert(dev)
                    dev = Dev("Dialog", "UserInterface", mContext.getString(R.string.UI_Dialogs_Summary))
                    devDao.insert(dev)
                    dev = Dev("Dialog", "UserInterface", mContext.getString(R.string.UI_Dialogs_Summary))
                    devDao.insert(dev)
